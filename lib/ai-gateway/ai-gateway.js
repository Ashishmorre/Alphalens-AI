...
// Per-model hard timeout (ms).
// With maxDuration=300 on the route, we give NVIDIA up to 270s before
// falling back to Groq — leaving 30s buffer for Vercel's function kill.
