...
async function attemptAIRequest({ systemPrompt, userPrompt, modelConfig }) {
  // CRITICAL FIX: Changed default temperature from 0.7 to 0.1 for financial accuracy
  // Temperature 0.7 = creative/hallucination-prone; 0.1 = deterministic/calculator-like
  const { model = 'llama3.1-8b', maxTokens = 4096, temperature = 0.1 } = modelConfig
