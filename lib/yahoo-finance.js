...
export function transformYahooData(ticker, { quote, summary }) {
  ...
  return {
    ...
    // (fiftyDayAverage and twoHundredDayAverage are the real field names from Yahoo)
    ma50: Number(quote.fiftyDayAverage) || null,
    ma200: Number(quote.twoHundredDayAverage) || null,
  }
}
