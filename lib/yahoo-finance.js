...
export function transformYahooData(ticker, { quote, summary }) {
	...
	return {
		...
		totalAssets: bs.totalAssets?.raw ?? null,
		totalCurrentAssets: bs.totalCurrentAssets?.raw ?? null,
		totalCurrentLiabilities: bs.totalCurrentLiabilities?.raw ?? null,
		interestExpense: is.interestExpense?.raw ?? null,
		quickRatio: fd.quickRatio?.raw ?? null,
		currentRatio: fd.currentRatio?.raw
			?? (bs.totalCurrentAssets?.raw && bs.totalCurrentLiabilities?.raw && bs.totalCurrentLiabilities.raw !== 0
				? bs.totalCurrentAssets.raw / bs.totalCurrentLiabilities.raw
				: null),
